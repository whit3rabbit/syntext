...
- [ ] All P0 bugs (B01–B08) fixed with regression tests
- [ ] All P1 bugs either fixed or documented with tracking issues
- [ ] `cargo test` passes (all test suites)
- [ ] `cargo test --features symbols` passes
...
- [ ] README.md updated (status, benchmarks current, version 1.0)
- [ ] All public APIs have doc comments
- [ ] Known limitations documented in README and ARCHITECTURE.md
